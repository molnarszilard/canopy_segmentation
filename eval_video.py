...
def parse_args():
    ...
    parser.add_argument('--input_file', dest='input_file', default='./dataset/input_images/flights/DJI_0607.mp4', type=str, help='path to a single input image for evaluation')
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        while currentFrame<totalFrames:
            ...
            save_image(imgmasked[0], save_path+"_"+str(currentFrame)+"_pred"+'.png')
